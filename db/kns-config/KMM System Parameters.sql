...
INSERT INTO KRNS_NMSPC_T ( NMSPC_CD, OBJ_ID, VER_NBR, NM, ACTV_IND, APPL_NMSPC_CD ) 
                  VALUES ( 'KFS-MM', sys_guid(), 1, 'Materiel Management', 'Y', NULL);
...
insert into KRNS_PARM_T (NMSPC_CD, PARM_DTL_TYP_CD, PARM_NM, OBJ_ID, VER_NBR, PARM_TYP_CD, TXT, PARM_DESC_TXT, CONS_CD, APPL_NMSPC_CD)
       values('KFS-MM', 'Document', 'STOCK_TYPES_WITH_SERIAL_NUM', SYS_GUID(), '1', 'CONFG', '02;03', 'The Stock Type code(s) that can be associated with trackable serial numbers', 'A', 'KFS');

insert into KRNS_PARM_T (NMSPC_CD, PARM_DTL_TYP_CD, PARM_NM, OBJ_ID, VER_NBR, PARM_TYP_CD, TXT, PARM_DESC_TXT, CONS_CD, APPL_NMSPC_CD)
       values('KFS-MM', 'Document', 'DEFAULT_WAREHOUSE_CD', SYS_GUID(), '1', 'CONFG', '74', 'The default Warehouse Code used for prepopulation in documents', 'A', 'KFS');
...
insert into KRNS_PARM_T (NMSPC_CD, PARM_DTL_TYP_CD, PARM_NM, OBJ_ID, VER_NBR, PARM_TYP_CD, TXT, PARM_DESC_TXT, CONS_CD, APPL_NMSPC_CD ) 
    values('KFS-MM', 'ShoppingCart', 'ALLOW_PERSONAL_USE', SYS_GUID(), 1, 'CONFG', 'N', 'Determines whether personal use profiles/external users are allowed in the Shopping portal', 'A', 'KFS');
