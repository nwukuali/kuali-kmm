...
(
  ...
  ACCOUNT_PCT              NUMBER(8,4) not null,
...
(
  ...
  ADDRESS_DEFAULT_IND VARCHAR2(1),
  ACTV_IND            VARCHAR2(1) not null,
  LAST_UPDATE_DT      TIMESTAMP(6) not null
)
;
...
create table MM_CAPITAL_ASSET_T
(
  CAPITAL_ASSET_ID  NUMBER(18) not null,
  OBJ_ID            VARCHAR2(36) default sys_guid() not null,
  VER_NBR           NUMBER(8) default 1 not null,
  ORDER_DETAIL_ID   NUMBER(18) not null,
  CAPITAL_ASSET_TYP VARCHAR2(20) not null,
  CAPITAL_ASSET_TAG NUMBER(12),
  ACTV_IND          VARCHAR2(1) not null,
  LAST_UPDATE_DT    TIMESTAMP(6) not null
)
;
alter table MM_CAPITAL_ASSET_T
  add constraint MM_CAPITAL_ASSET_TP1 primary key (CAPITAL_ASSET_ID);
alter table MM_CAPITAL_ASSET_T
  add constraint MM_CAPITAL_ASSET_TC0 unique (OBJ_ID);
...
(
  ...
  OBJ_ID                   VARCHAR2(36) default sys_guid() not null,
  VER_NBR                  NUMBER(8) default 1 not null,
  CATALOG_PENDING_ID       NUMBER(18) not null,
...
alter table MM_CATALOG_ITEM_PENDING_T
  add constraint MM_CATALOG_ITEM_PENDING_TC0 unique (CATALOG_PENDING_ID, DISTRIBUTOR_NBR);
...
create table MM_CATALOG_PENDING_T
(
  CATALOG_PENDING_ID NUMBER(18) not null,
  OBJ_ID             VARCHAR2(36) default sys_guid() not null,
  VER_NBR            NUMBER(8) default 1 not null,
...
alter table MM_CATALOG_PENDING_T
  add constraint MM_CATALOG_PENDING_TP1 primary key (CATALOG_PENDING_ID);
alter table MM_CATALOG_PENDING_T
...
alter table MM_CATALOG_SUBGROUP_ITEM_T
  add constraint MM_CATALOG_SUBGROUP_ITEM_TC0 unique (OBJ_ID);
...
(
  ...
  PRIOR_CATALOG_SUBGROUP_CD VARCHAR2(12),
  ACTV_IND                  VARCHAR2(1) not null,
  LAST_UPDATE_DT            TIMESTAMP(6) not null
)
;
...
(
  ...
  EHS_CONVERSION_UNIT_FACTOR NUMBER(4,3),
...
(
  ...
  MARKUP_DESC        VARCHAR2(200),
  MARKUP_RT          NUMBER(8,2),
  WAREHOUSE_CD       VARCHAR2(2),
  MARKUP_COA_CD      VARCHAR2(2),
  MARKUP_ORG_CD      VARCHAR2(4),
  MARKUP_ACCOUNT_NBR VARCHAR2(7),
...
(
  ...
  DELIVERY_BUILDING_CD       VARCHAR2(4),
...
(
  ...
  DELIVERY_BUILDING_CD     VARCHAR2(4),
  DELIVERY_BUILDING_RM_NBR VARCHAR2(8),
  BILLING_BUILDING_CD      VARCHAR2(4),
  ORG_CD                   VARCHAR2(4),
...
alter table MM_PROFILE_T
  add constraint MM_PROFILE_TC0 unique (CUSTOMER_PRNCPL_ID, PROFILE_NM);
...
(
  ...
  VENDOR_DETAIL_ASSIGNED_ID  NUMBER(10),
  VENDOR_NM                  VARCHAR2(45),
  RETRIEVAL_BUILDING_CD      VARCHAR2(4),
...
alter table MM_CAPITAL_ASSET_T
  add constraint MM_CAPITAL_ASSET_TR1 foreign key (ORDER_DETAIL_ID)
  references MM_ORDER_DETAIL_T (ORDER_DETAIL_ID);
...
alter table MM_CATALOG_ITEM_PENDING_T
  add constraint MM_CATALOG_ITEM_PENDING_TR1 foreign key (CATALOG_PENDING_ID)
  references MM_CATALOG_PENDING_T (CATALOG_PENDING_ID);
...
alter table MM_CATALOG_T
  add constraint MM_CATALOG_TR1 foreign key (CATALOG_PENDING_ID)
  references MM_CATALOG_PENDING_T (CATALOG_PENDING_ID);
alter table MM_CATALOG_T
...
alter table MM_CUSTOMER_FAV_HEADER_T
  add constraint MM_CUSTOMER_FAV_HEADER_TR1 foreign key (PRNCPL_ID)
  references MM_CUSTOMER_T (PRNCPL_ID);
...
alter table MM_PROFILE_T
  add constraint MM_PROFILE_TR1 foreign key (CUSTOMER_PRNCPL_ID)
  references MM_CUSTOMER_T (PRNCPL_ID);
...
alter table MM_WAREHOUSE_T
  add constraint MM_WAREHOUSE_TR1 foreign key (AGREEMENT_NBR)
  references MM_AGREEMENT_T (AGREEMENT_NBR);
