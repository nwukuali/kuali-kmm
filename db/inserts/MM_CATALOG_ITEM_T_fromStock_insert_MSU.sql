...
select MM_CATALOG_ITEM_S.nextval, 
       ...
       MM_STOCK_COST_T.STOCK_CST,
       MM_STOCK_T.STOCK_DESC,
       nvl(MM_STOCK_T.RECYCLED_IND,'N'),
       ...
       (select catalog_id from mm_catalog_t where catalog_cd = nvl(MM_ZONE_T.WAREHOUSE_CD,'74')),
       MM_STOCK_T.STOCK_ID,
       'Y',
       NULL,
       NULL,
...
JOIN MM_STOCK_COST_T
   ...
   AND MM_STOCK_COST_T.COST_CD = '01'
