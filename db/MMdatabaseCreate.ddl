...
(
  ...
  ADDRESS_PROFILE_ID NUMBER(18) not null,
...
(
  AGREEMENT_NBR       VARCHAR2(50) not null,
  OBJ_ID              VARCHAR2(36) default sys_guid() not null,
  VER_NBR             NUMBER(8) default 1 not null,
  PO_ID               NUMBER(18),
...
(
  ...
  FILLED_IND            VARCHAR2(1) not null,
  CANCELED_IND          VARCHAR2(1) not null,
  LAST_UPDATE_DT        TIMESTAMP(6) not null
)
;
...
(
  ...
  VER_NBR                       NUMBER(8) default 1 not null,
  NM                            VARCHAR2(45),
  CUSTOMER_VENDOR_RETURN_IND    VARCHAR2(1),
  ACTV_IND                      VARCHAR2(1) not null,
  LAST_UPDATE_DT                TIMESTAMP(6) not null
)
;
...
alter table MM_CATALOG_IMAGE_T
  add constraint MM_CATALOG_IMAGE_TR1 foreign key (CATALOG_ID)
...
alter table MM_STOCK_T
  add constraint MM_STOCK_TR4 foreign key (STOCK_AGREEMENT_NBR)
  references MM_AGREEMENT_T (AGREEMENT_NBR);
alter table MM_STOCK_T
  add constraint MM_STOCK_TR5 foreign key (RESTRICTED_ROUTE_CD)
  references MM_RESTRICTED_ROUTE_CODE_T (RESTRICTED_ROUTE_CD);
alter table MM_STOCK_T
  add constraint MM_STOCK_TR6 foreign key (CYLINDER_GAS_CD)
