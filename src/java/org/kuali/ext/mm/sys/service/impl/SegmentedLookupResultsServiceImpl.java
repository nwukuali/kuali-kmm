 ...
 */
@Transactional
public class SegmentedLookupResultsServiceImpl extends LookupResultsServiceImpl implements
        SegmentedLookupResultsService {

    /**
     *
     */
    private static final long serialVersionUID = -4518959596917619672L;
    ...
    public void persistResultsTable(String lookupResultsSequenceNumber,
            List<ResultRow> resultTable, String personId) throws Exception {
        String resultTableString = new String(Base64.encodeBase64(ObjectUtils
                .toByteArray(resultTable)));
    ...
    /**
     * @see org.kuali.rice.kns.lookup.LookupResultsService#persistSelectedObjectIds(java.lang.String, java.util.Set,
     *      java.lang.String)
     */
    @Override
    public void persistSelectedObjectIds(String lookupResultsSequenceNumber,
            Set<String> selectedObjectIds, String personId) throws Exception {
        ...
        selectedObjectIdsBO.setSelectedObjectIds(LookupUtils
                .convertSetOfObjectIdsToString(selectedObjectIds));
    ...
    public List<ResultRow> retrieveResultsTable(String lookupResultsSequenceNumber, String personId)
        ...
        if (!isAuthorizedToAccessLookupResults(lookupResults, personId)) {
            throw new AuthorizationException(personId, "retrieve lookup results",
                "lookup sequence number " + lookupResultsSequenceNumber);
        }
        List<ResultRow> resultTable = (List<ResultRow>) ObjectUtils.fromByteArray(Base64
                .decodeBase64(lookupResults.getSerializedLookupResults().getBytes()));
        return resultTable;
    }
     ...
     */
    @Override
    public Collection<PersistableBusinessObject> retrieveSelectedResultBOs(
            String lookupResultsSequenceNumber, Class boClass, String personId) throws Exception {
        Set<String> setOfSelectedObjIds = retrieveSetOfSelectedObjectIds(
                lookupResultsSequenceNumber, personId);
        return retrieveSelectedResultBOs(lookupResultsSequenceNumber, setOfSelectedObjIds, boClass,
                personId);
    }
    ...
    public Set<String> retrieveSetOfSelectedObjectIds(String lookupResultsSequenceNumber,
        ...
        Set<String> retval = LookupUtils.convertStringOfObjectIdsToSet(selectedObjectIds
     ...
     */
    public Collection<PersistableBusinessObject> retrieveSelectedResultBOs(
            String lookupResultsSequenceNumber, Set<String> setOfSelectedObjIds, Class boClass,
            String personId) throws Exception {
        LOG.debug("Retrieving results for class " + boClass + " with objectIds "
                + setOfSelectedObjIds);
