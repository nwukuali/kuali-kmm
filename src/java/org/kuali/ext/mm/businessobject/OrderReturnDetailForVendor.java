 ...
 * @author rponraj
 */
public class OrderReturnDetailForVendor extends StoresPersistableBusinessObject implements
        Cloneable {
    private static final long serialVersionUID = 9090101771971531636L;
