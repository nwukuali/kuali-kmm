 ...
 */
public class WarehouseGlGroup extends GlLineGroup {
    private static final long serialVersionUID = -1180736011235586322L;
    private FinancialGeneralLedgerPendingEntry targetEntry;
    private List<FinancialGeneralLedgerPendingEntry> sourceEntries = new ArrayList<FinancialGeneralLedgerPendingEntry>();
     ...
     * @param entry GL Line
     */
    public WarehouseGlGroup(FinancialGeneralLedgerPendingEntry entry) {
        ...
        this.targetEntry = (FinancialGeneralLedgerPendingEntry) ObjectUtils.deepCopy(entry);

        KualiDecimal amount = entry.getTransactionLedgerEntryAmount();
        if (GlConstants.GL_CREDIT.equals(entry.getTransactionDebitCreditCode())) {
            // negate the amount
     ...
     */
    public boolean isAccounted(FinancialGeneralLedgerPendingEntry entry) {
        WarehouseGlGroup test = new WarehouseGlGroup(entry);
     ...
     * @param entry
     */
    public void combineEntry(FinancialGeneralLedgerPendingEntry newEntry) {
        ...
        if (GlConstants.GL_CREDIT.equals(targetDebitCreditCode)) {
     ...
     */
    public FinancialGeneralLedgerPendingEntry getTargetEntry() {
        return targetEntry;
    }
     ...
     */
    public void setTargetEntry(FinancialGeneralLedgerPendingEntry targetGlEntry) {
     ...
     */
    public List<FinancialGeneralLedgerPendingEntry> getSourceEntries() {
     ...
     */
    public void setSourceEntries(List<FinancialGeneralLedgerPendingEntry> sourceGlEntries) {
