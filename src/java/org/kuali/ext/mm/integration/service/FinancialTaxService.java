...
public interface FinancialTaxService {
     ...
     * @return
     */
    List<FinancialTaxDetail> getSalesTaxDetails(Date dateOfTransaction, String postalCode,
            KualiDecimal amount);
     ...
     * @return
     */
    List<FinancialTaxDetail> getUseTaxDetails(Date dateOfTransaction, String postalCode,
            KualiDecimal amount);
     ...
     * @return
     */
    KualiDecimal getTotalSalesTaxAmount(Date dateOfTransaction, String postalCode,
            KualiDecimal amount);
     ...
     * @return
     */
    KualiDecimal getPretaxAmount(Date dateOfTransaction, String postalCode,
