...
<c:set var="epMethodToCallAttribute" value="methodToCall.performLookup.(!!${boClassName}!!).(:;${lookedUpCollectionName};:).(((${fieldConversions}))).((#${lookupParameters}#)).((&${readOnlyFields}&)).((%true%)).anchor${anchor}"/>
