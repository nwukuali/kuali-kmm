...
<%@ attribute name="orderDetailLineId" required="true" description="Number to identify the detail line for which this capital asset information applies."%>
	
<c:set var="attributes" value="${DataDictionary.MMCapitalAssetInformationDetail.attributes}" />		
	...
	<table style="border-top: 1px solid rgb(153, 153, 153); width: 90%;" cellpadding="0" cellspacing="0" class="datatable" summary="Capital Asset Information Details">  
	   ...
	   <tr>
			...
			<fp:dataCell dataCellCssClass="${dataCellCssClass}"
				...
				boClassSimpleName="FinancialBuilding" boPackageName="org.kuali.ext.mm.integration.sys.businessobject"
			...
			<fp:dataCell dataCellCssClass="${dataCellCssClass}"
				...
				boClassSimpleName="FinancialRoom" boPackageName="org.kuali.ext.mm.integration.sys.businessobject"
			...
			<c:if test="${!readOnly}">
				<td class="infoline">  
					<div style="text-align: center;">			 
						 <html:image property="methodToCall.deleteCapitalAssetInfoDetailLine.line${status.index}.item${orderDetailLineId }" 
