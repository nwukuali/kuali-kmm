...
<c:set var="attributes" value="${DataDictionary.MMCapitalAssetInformation.attributes}" />	
...
<table class="datatable" style="border-top: 1px solid rgb(153, 153, 153);" cellpadding="0" cellspacing="0" summary="Capital Asset Information">
   	...
   	<tr>                        
	    ...
	    <fp:dataCell dataCellCssClass="${dataCellCssClass}"
			...
			boClassSimpleName="FinancialAsset" boPackageName="org.kuali.ext.mm.integration.cam.businessobject"
...
<table class="datatable" style="border-top: 1px solid rgb(153, 153, 153);"  cellpadding="0" cellspacing="0" summary="Capital Asset Information">
   ...
   <tr>
		...
		<fp:dataCell dataCellCssClass="${dataCellCssClass}"
			...
			boClassSimpleName="FinancialAssetType" boPackageName="org.kuali.ext.mm.integration.cam.businessobject" 
			lookupOrInquiryKeys="capitalAssetTypeCode"
			lookupUnkeyedFieldConversions="capitalAssetTypeCode:${capitalAssetInfoName}.capitalAssetTypeCode,"
			businessObjectValuesMap="${capitalAssetInfo.valuesMap}"/>		
			   
		<fp:dataCell dataCellCssClass="${dataCellCssClass}"
			businessObjectFormName="${capitalAssetInfoName}" attributes="${attributes}" readOnly="${readOnly}"
			field="vendorName" lookup="true" inquiry="true" disabled="true"
			boClassSimpleName="FinancialVendorDetail" boPackageName="org.kuali.ext.mm.integration.vnd.businessobject"
			lookupOrInquiryKeys="vendorHeaderGeneratedIdentifier,vendorDetailAssignedIdentifier,vendorName"
			lookupUnkeyedFieldConversions="vendorHeaderGeneratedIdentifier:${capitalAssetInfoName}.vendorHeaderGeneratedIdentifier,vendorDetailAssignedIdentifier:${capitalAssetInfoName}.vendorDetailAssignedIdentifier,vendorName:${capitalAssetInfoName}.vendorName,"
			businessObjectValuesMap="${capitalAssetInfo.valuesMap}" />	
	...
	<tr>
		<td class="infoline">  
			<div style="text-align: center;">	
				<html:image property="methodToCall.addCapitalAssetInfo.line${detailLineId }" 
					src="${ConfigProperties.kr.externalizable.images.url}tinybutton-add1.gif" 
					title="Add the capital Asset Information"
					alt="Add the capital Asset Information" styleClass="tinybutton" />	
				<br /><br />	 
				<html:image property="methodToCall.clearCapitalAssetInfo.line${detailLineId }" 
   ...
   <tr><td colSpan="5"><center><br/>
		<fp:capitalAssetInfoDetail capitalAssetInfoDetails="${capitalAssetInfo.capitalAssetInformationDetails}" 
			capitalAssetInfoDetailsName="${capitalAssetInfoName}.capitalAssetInformationDetails" readOnly="${readOnly}" orderDetailLineId="${detailLineId }" />
	<br/></center></td></tr>
</table>
