...
<table border="0" width="100%"  cellspacing="0" cellpadding="0" id="iframe_portlet_container_table">
 ...
 <div class="footerbevel">&nbsp;</div>
  <div id="footer-copyright"> <bean:message key="app.copyright" arg0="${ConfigProperties.current.year}" arg1="${ConfigProperties.finance.system.url}/acknowledgements.jsp" /></div>
