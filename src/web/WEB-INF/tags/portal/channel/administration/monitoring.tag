...
<div class="body">
	<strong>Service Bus</strong></br>
   	<ul class="chan">
		<li><portal:portalLink displayTitle="true" title="Message Queue" url="${ConfigProperties.ksb.server.url}/ksb/MessageQueue.do" /></li>
		<li><portal:portalLink displayTitle="true" title="Service Registry" url="${ConfigProperties.ksb.server.url}/ksb/ServiceRegistry.do" /></li>
		<li><portal:portalLink displayTitle="true" title="Thread Pool" url="${ConfigProperties.ksb.server.url}/ksb/ThreadPool.do" /></li>
	</ul>
