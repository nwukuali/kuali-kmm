...
<div class="body">
	<strong>Materiel Management</strong>
    <ul class="chan">
		<li><portal:portalLink displayTitle="true" title="Order Correction" url="orderCorrection.do?methodToCall=start" /></li>
		<li><portal:portalLink displayTitle="true" title="Batch Jobs" url="batchControl.do?methodToCall=start" /></li>
		<li><portal:portalLink displayTitle="true" title="Upload Catalog Images" url="catalogImage.do?methodToCall=upload" /></li>
		<li><portal:portalLink displayTitle="true" title="Post CXML" url="postCxml.do?methodToCall=postCxml" /></li>
	</ul>
